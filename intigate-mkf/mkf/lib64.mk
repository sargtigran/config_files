...
compiler_flags := -m64 -Dx86_64 -D__x86_64__ $(filter-out -m32, $(compiler_flags))
linker_flags := -m64 $(filter-out -m32, $(linker_flags))
asm_compiler_flags := -m64 $(filter-out -m32, $(asm_compiler_flags))

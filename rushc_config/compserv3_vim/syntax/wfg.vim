...
syn keyword wfgOperator clz  mac  smac sqadd  brvs lrot rrot lsign rxor
syn keyword wfgOperator fork sink cle monitor assert inv define


" Keywords.
syn keyword wfgKeyword module endmodule mem include cond endcond else ram rom
...
syn region  wfgComment start=/\/\*/  end=/\*\//
...
if version >= 508 || !exists("did_c_syn_inits")
  ...
  HiLink wfgInstance WfgInstance

...
highlight CustoumFunction ctermfg=179
...
if version >= 508 || !exists("did_cpp_syntax_inits")
  ...
  HiLink cppSTLbool         Boolean "red
  HiLink cppStorageClass    StorageClass
  HiLink cppStatement       Statement
  HiLink cppSTLfunction     CustomFunction
  HiLink cppSTLfunctional   Typedef "green
  HiLink cppSTLconstant     Constant "red
  HiLink cppSTLnamespace    Constant
  HiLink cppSTLtype         Typedef
  HiLink cppSTLexception    Exception "orange
  HiLink cppSTLiterator     Typedef
  HiLink cppSTLiterator_tag Typedef
  HiLink cppSTLenum         Typedef
  HiLink cppSTLios          Function "cyan
  HiLink cppSTLcast         Statement " be consistent with official syntax
  HiLink cppRawString       String "red
